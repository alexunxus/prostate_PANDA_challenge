...
_C.MODEL = CN()
_C.MODEL.BACKBONE          = 'baseline' #'baseline', 'R-50-xt', 'R-50-st', 'enet-b0', 'enet-b1'
...
_C.MODEL.RESUME_FROM       = ''#'/workspace/prostate_isup/checkpoint/enet-b1_8_784best_kappa.pth'
